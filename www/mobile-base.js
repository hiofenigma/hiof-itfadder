// API key for IT-fadder Please get your own at
// http://bingmapsportal.com/ and use that instead.
var apiKey = " 	Ai4IyMoSkrO8rFrAjFdVlamVLxUludKVCwpteCOQjHAFd5XSZ1QNyqS3iUVOPvrW";
...
var lonLatToMercator = function(lon, lat){
	var lonx = 6378137.0 * 3.14159265 / 180.0 * lon;
	var laty = 6378137.0 * Math.log(Math.tan(3.14159265 / 180 * (45 + lat / 2.0)));
	return new OpenLayers.LonLat(lonx, laty);
};
